...
class DeepQNetwork:
    def __init__(
        ...
        # 替换 target net 的参数
        self.t_params = tf.get_collection('target_net_params')  # 提取 target_net 的参数
        self.e_params = tf.get_collection('eval_net_params')  # 提取  eval_net 的参数
        self.replace_target_op = [tf.assign(t, e) for t, e in zip(self.t_params, self.e_params)]  # 更新 target_net 参数
...
class SarsaLambdaTable(RL):
    ...
    def learn(self, s, a, r, s_, a_):
        ...
        self.eligibility_trace.ix[s, a] = 1
        self.q_table += self.lr * (q_target - q_predict) * self.eligibility_trace  # update
